-- brenton-leighton/multiple-cursors.nvim: A multi-cursor plugin for Neovim that
-- works in normal, insert/replace, or visual modes, and with almost every command
